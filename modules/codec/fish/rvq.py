...
class VQResult:
    ...
    semantic_distill_z: Union[torch.Tensor, None] = None
...
class DownsampleResidualVectorQuantize(nn.Module):
    def __init__(
        ...
        downsample_dims: Union[tuple[int], None] = None,
        pre_module: Union[nn.Module, None] = None,
        post_module: Union[nn.Module, None] = None,
        semantic_predictor_module: Union[nn.Module, None] = None,
    ):
        super().__init__()
