...
from modules.asr.spk_embed.pooling import TemporalAveragePooling, TemporalStatsPool, AttentiveStatisticsPooling
...
class ERes2Net(nn.Module):
    ...
    def encode(self, x):
        ...
        if self.two_emb_layer:
            ...
            return F.normalize(embed_b, dim=-1)
        else:
            return F.normalize(embed_a, dim=-1)
