...
from modules.vocoder.commons.source import SourceModuleHnNSF, SourceModuleCycNoise_v1
        ...
        if h['nsf_type'] != 'none':
            ...
            for i, u in enumerate(h['upsample_rates'][::-1]):
                ...
                self.noise_convs.append(nn.Conv1d(
                    c_in_noise, c_out_noise, u * 2, u, padding=(u + 1) // 2))
