...
class LLaMa(nn.Module):
    ...
    def forward(self, x, t, attn_mask, start_pos=0, use_cache=False, do_checkpoint=False):
        ...
        for i, layer in enumerate(self.layers):
            if torch.is_grad_enabled() and do_checkpoint:
                ...
                x = torch.utils.checkpoint.checkpoint(
                    ...
                    x, t, start_pos, freqs_cis, attn_mask, use_cache, **ckpt_kwargs,
                )

            else:
                x = layer(x, t, start_pos, freqs_cis, attn_mask, use_cache=use_cache)
