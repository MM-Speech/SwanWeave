...
import data_gen.sr.audiosr.latent_diffusion.modules.phoneme_encoder.text as text
from data_gen.sr.audiosr.latent_diffusion.models.ddpm import LatentDiffusion
from data_gen.sr.audiosr.latent_diffusion.util import get_vits_phoneme_ids_no_padding
from data_gen.sr.audiosr.audiosr_utils import (
...
def make_batch_for_super_resolution(input_file, waveform=None, fbank=None, normalize_waveform=True):
    if waveform is None:
...
def super_resolution_long_audio(
    ...
    """
    Deprecated/internal: AudioSR API owns long-audio chunking now.
