...
import numpy as np
from data_gen.sr.audiosr.latent_diffusion.modules.ema import *

from data_gen.sr.audiosr.latent_diffusion.modules.diffusionmodules.model import Encoder, Decoder
from data_gen.sr.audiosr.latent_diffusion.modules.distributions.distributions import (
    DiagonalGaussianDistribution,
)
import soundfile as sf

from data_gen.sr.audiosr.utilities.model import get_vocoder
from data_gen.sr.audiosr.utilities.tools import synth_one_sample
...
class AutoencoderKL(nn.Module):
    ...
    def decode_to_waveform(self, dec):
        from data_gen.sr.audiosr.utilities.model import vocoder_infer
