...
import torch
import logging
from data_gen.sr.audiosr import super_resolution, super_resolution_long_audio, build_model, save_wave, get_time, read_list
import argparse
...
parser.add_argument(
    ...
    required=False,
    default=None,
    help="AudioSR checkpoint root. Defaults to pretrained_models/sr/audiosr.",
)

parser.add_argument(
    "--allow_download",
    action="store_true",
    help="Download the checkpoint explicitly if it is missing from model_root.",
)
